...
SWIFT_CLASS("_TtC20BLEUnderstandingTest11AppDelegate")
...
SWIFT_CLASS("_TtC20BLEUnderstandingTest10BLEManager")
@interface BLEManager : NSObject <CBCentralManagerDelegate>

/// Testing that this works
+ (BLEManager * _Nonnull)sharedManager;
@property (nonatomic, strong) CBCentralManager * _Nullable centralManager;
@property (nonatomic, copy) NSString * _Nullable observableUpdate;
...
/// \param central test
///
/// \param peripheral test
///
/// \param advertisementData test
///
/// \param RSSI test
...
SWIFT_CLASS("_TtC20BLEUnderstandingTest14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified beginScanButton;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified reportLabel;
@property (nonatomic, strong) BLEManager * _Nullable centralManager;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)beginScan:(id _Nonnull)sender;
